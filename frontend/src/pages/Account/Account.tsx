...
const Account: FC = (): ReactElement => {
    ...
    return (
        <ContentWrapper>
            <Row gutter={32}>
                <Col span={5}>
                    <ContentTitle title={"Мій акаунт"} titleLevel={4} icon={<UserOutlined />} />
                    <AccountLink link={ACCOUNT_USER_INFO} title={"Особисті дані"} />
                    {isAdmin ? (
                        <>
                            <AccountLink link={ACCOUNT_ADMIN_ADD} title={"Добавити техніку"} />
                            <AccountLink link={ACCOUNT_ADMIN_PRODUCTS} title={"Список техніки"} />
                            <AccountLink link={ACCOUNT_ADMIN_ORDERS} title={"Замовлення"} />
                            <AccountLink link={ACCOUNT_ADMIN_USERS} title={"Користувачі"} />
                        </>
                    ) : (
                        <>
                            <AccountLink link={ACCOUNT_USER_EDIT} title={"Змінити пароль"} />
                            <AccountLink link={ACCOUNT_USER_ORDERS} title={"Список замовлень"} />
                        </>
                    )}
                </Col>
                <Col span={19}>
