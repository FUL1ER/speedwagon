...
const Registration: FC = (): ReactElement => {
    ...
    return (
        <ContentWrapper>
            <ContentTitle icon={<UserAddOutlined />} title={"Реєстрація"} />
            <Row gutter={32}>
                <Col span={12}>
                    <Form onFinish={onClickSignIn}>
                        ...
                        <FormInput
                            ...
                            inputPassword
                        />
                        <IconButton disabled={isLoading} title={"Зареєструватись"} icon={<UserAddOutlined />} />
                        <Form.Item
                        ...
                        >
                            <ReCAPTCHA
                                ...
                                sitekey="6LfdT50gAAAAABYZpcGtY67uMXXxt1kj2V1NdKvP"
                            />
                        </Form.Item>
                    </Form>
                </Col>
