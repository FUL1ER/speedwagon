...
export const selectProduct = (state: RootState): Partial<Product> => state.product.product;
export const selectReviews = (state: RootState): Array<Review> => state.product.reviews;
