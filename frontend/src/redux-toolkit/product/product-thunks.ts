...
export const fetchProduct = createAsyncThunk<Partial<Product>, string, { rejectValue: string }>(
...
export const fetchReviewsByProductId = createAsyncThunk<Array<Review>, string>(
...
// GraphQL thunks
export const fetchProductByQuery = createAsyncThunk<Partial<Product>, string, { rejectValue: string }>(
