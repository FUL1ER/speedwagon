...
import { LoadingStatus, Product } from "../../types/types";
...
export const cartSlice = createSlice({
    ...
    initialState,
    reducers: {
        calculateCartPrice(state, action: PayloadAction<Array<Product>>) {
...
const calculatePrice = (products: Array<Product>): number => {
