...
import { HeaderResponse, Product, ProductErrors, User } from "../../types/types";
...
export const updateProduct = createAsyncThunk<Product, FormData, { rejectValue: ProductErrors }>(
    "admin/updateProduct",
    async (data, thunkApi) => {
        try {
