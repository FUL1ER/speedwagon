...
import "./NavBar.scss";
import Logo from "https://mywebstoragespring.s3.eu-central-1.amazonaws.com/Logo.jpg";
    ...
    return (
        <>
            <div className={"navbar-logo-wrapper"}>
                <img alt={"navbar-logo"} src="https://mywebstoragespring.s3.eu-central-1.amazonaws.com/Logo.jpg"/>
            </div>
            <Affix>
                    ...
                    <Row style={{padding: "0px 400px"}}>
                        <Col span={12}>
                            <ul>
                                ...
                                <li>
                                    <Link to={{pathname: MENU, state: {id: ""}}}>ТЕХНІКА</Link>
                                </li>
                                <Link to={CONTACTS}>
                                    <li>КОНТАКТИ</li>
                                </Link>
