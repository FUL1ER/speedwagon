...
-- INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price)
--     VALUES (3, 'Kurbas street 1', 'Ukraine', '2021-04-07', 'ivan123@test.com', 'Ivan', 'Ivanenko', '1234567890', 1234567890, 163);
-- INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price)
--     VALUES (4, 'Kurbas street 1', 'Ukraine', '2021-04-07', 'ivan123@test.com', 'Ivan', 'Ivanenko', '1234567890', 1234567890, 780);
-- INSERT INTO orders (id, address, city, date, email, first_name, last_name, phone_number, post_index, total_price)
--     VALUES (5, 'Kurbas street 1', 'Ukraine', '2021-04-07', 'ivan123@test.com', 'Ivan', 'Ivanenko', '1234567890', 1234567890, 196);
--
